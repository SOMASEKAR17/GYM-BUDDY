...
export default function DiscoverPage() {
  ...
  const onMouseMove = (e: React.MouseEvent) => {
    ...
    cardRef.current.style.opacity = String(
      1 - Math.abs(currentX.current) / 400,
    );
  };
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            You&apos;ve seen all available profiles. Check back soon as more VIT
            students join GymBuddy.
          </p>
          <button
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "linear-gradient(rgba(230,57,71,0.02) 1px, transparent 1px), linear-gradient(90deg, rgba(230,57,71,0.02) 1px, transparent 1px)",
      ...
      {matchAnimation && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <div
                style={{
                  ...
                  height: 80,
                  borderRadius: "50%",
                  background: current?.profileImage
                    ? `url(${current.profileImage})`
                    : "linear-gradient(135deg, var(--color-accent), var(--color-accent-dark))",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                  border: "3px solid white",
            ...
            >
              You and {current?.name} both liked each other. Head over to
              matches to start chatting!
            </p>
            <button
              ...
              >
                <div
                  style={{
                    ...
                    height: 36,
                    borderRadius: "50%",
                    backgroundImage: next.profileImage
                      ? `url(${next.profileImage})`
                      : "linear-gradient(135deg, #333, #555)",
                    backgroundSize: "cover",
                    ...(next.profileImage && { backgroundPosition: "center" }),
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "white",
            ...
            >
              <div
                style={{
                  ...
                  height: 100,
                  borderRadius: "50%",
                  backgroundImage: current.profileImage
                    ? `url(${current.profileImage})`
                    : "linear-gradient(135deg, var(--color-accent), var(--color-accent-dark))",
                  backgroundSize: "cover",
                  ...(current.profileImage && { backgroundPosition: "center" }),
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  color: "white",
                ...
                {[
                  {
                    ...
                    label: "Split",
                    value:
                      current.questionnaire?.workoutSplit
                  ...
                  },
                  {
                    ...
                    label: "Time",
                    value:
                      current.questionnaire?.workoutTime?.split(" ")[0] || "—",
                  },
                  {
                    icon: <Target size={12} />,
                    label: "Goal",
                    value: current.fitnessGoal?.split(" ")[0] || "—",
                  },
                ].map((stat) => (
                  <div
                    key={stat.label}
              ...
              <div style={{ marginTop: "14px" }}>
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${current.compatibilityScore}%`,
                      background:
